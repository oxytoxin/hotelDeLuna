            ...
            <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
              <div class="flex justify-between px-2 py-3 bg-white border-b border-gray-200 sm:px-6">
                <div class="flex space-x-2">
                  ...
                  <x-native-select wire:model='status_filter' placeholder="Room Status">
                ...
                <thead class="bg-primary-600">
                  <tr>
                    @foreach ($headers as $header)
                      <th scope="col" x-id="['header']" :id="$id('header')" wire:key="{{ $header }}"
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  @forelse ($rooms as $room)
                    <tr @class([
                      ...
                      @if ($status_filter == 2 || $status_filter == '')
                        <td class="px-3 py-4 text-sm whitespace-nowrap">
                          <div>
                      ...
                      @if ($status_filter == 7 || $status_filter == '')
                        <td class="px-3 py-4 text-sm whitespace-nowrap">
                            ...
                            @else
                              <div class="relative flex space-x-2">
                                <x-countdown :expires="$time_to_clean">
                                  <span x-cloak x-show="timer.hours == '00'"
