    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="border-b border-gray-200 bg-white ">
            <div class="-ml-4 -mt-4 flex flex-wrap items-center justify-between sm:flex-nowrap">
                <div class="ml-4 mt-4">
                    <h3 class="text-xl font-bold leading-6 text-gray-700">TYPES</h3>
                    <p class="mt-1 text-sm text-gray-500">A list of all types
                        </p>
                </div>
                <div class="ml-4 mt-4 flex-shrink-0">
                    <div class="flex justify-between space-x-1 items-center">
                        <div class="flex border items-center px-3 rounded-lg">
                            ...
                            <input type="text" wire:model="search_type"
              ...
              <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                <table class="min-w-full">
                  <thead class="bg-white">
                    <tr>
                      <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-700 sm:pl-6">ROOM TYPE</th>
                  ...
                  <tr class="border-t border-gray-200">
                    <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-700 sm:pl-6">{{$type->name}}</td>
      ...
      <div wire:key="create_modal" class="z-0">
        <x-modal.card  title="Add New Type " blur wire:model.defer="create_modal">
            <x-input label="Room Type"
            placeholder="Enter name"
            wire:model.defer="name" />
            <x-slot:footer>
                <div class="flex w-full justify-end items-center space-x-2">
                    <x-button positive wire:click="saveType">Save</x-button>
      ...
      <div wire:key="edit_modal" class="z-0">
        <x-modal.card  title="Edit Rate " blur wire:model.defer="edit_modal">
            ...
            <x-slot:footer>
                <div class="flex w-full justify-end items-center space-x-2">
                    <x-button positive wire:click="updateType">Save</x-button>
