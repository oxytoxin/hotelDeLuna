    ...
    <div class="flex-1 relative">
                  ...
                  <div class="flex justify-between">
                    <dt class="">
                      <div class="flex flex-col">
                        ...
                        <div class="text-gray-300"> RM #{{ $transaction->check_in_detail->room->number }} |
                          {{ ordinal($transaction->check_in_detail->room->floor->number) }} FLOOR</div>
                      </div>
                    </dt>
                    <dd class="text-lg font-bold text-white">&#8369;{{ number_format($transaction->payable_amount, 2) }}
                    </dd>
                  </div>
                @break
      ...
      <div class="bg-white bg-opacity-30 p-5 py-8 w-96 shadow-2xl rounded-3xl">
        ...
        <div class="flex flex-auto flex-col justify-between p-6">
          ...
          <div class="mt-20 justify-center flex w-full">
            <a href="{{ route('kiosk.transaction') }}"
              class="w-full bg-white text-gray-700 text-xl text-center font-bold py-2 px-4 rounded-full">
              OK
            </a>
          </div>
        </div>
            ...
            <div class="absolute top-0 right-0 bottom-0 left-0 flex justify-center items-center">
              <div class="flex flex-col justify-center items-center  bg-opacity-70  w-full mx-10 rounded-2xl">
                <input type="number" autofocus wire:model="scanner"
                  class="w-full shadow-xl bg-gray-100 rounded-2xl text-gray-600 h-20 text-3xl font-bold text-center">
                <div class="mt-5">
