    ...
    <div x-ref="printContainer" class="mt-5 flex flex-col">
      ...
      <table id="example" class="table-auto mt-5" style="width:100%">
        <thead class="font-normal">
          <tr>
            <th class="border border-gray-700 text-left px-2 text-sm font-semibold text-gray-700 py-2">FROM ROOM #</th>
            <th class="border border-gray-700 text-left px-2 text-sm font-semibold text-gray-700 py-2">TRANSFER TO ROOM
              #</th>
            <th class="border border-gray-700 text-left px-2 text-sm font-semibold text-gray-700 py-2">REASON</th>
        ...
        <tbody class="">
          @foreach ($roomChanges as $change)
            <tr>
              <td class="border border-gray-700 px-2 py-2 text-sm text-gray-700">{{ $change->fromRoom->number }}</td>
              <td class="border border-gray-700 px-2 py-2 text-sm text-gray-700">{{ $change->toRoom->number }}</td>
              <td class="border border-gray-700 px-2 py-2 text-sm text-gray-700">{{ $change->reason }}</td>
              <td class="border border-gray-700 px-2 py-2 text-sm text-gray-700">{{ $change->front_desk_name }}</td>
            </tr>
          @endforeach
        </tbody>
      </table>
