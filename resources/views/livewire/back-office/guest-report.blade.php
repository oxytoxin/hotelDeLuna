        ...
        @switch($report_type)
            @case(1)
                <div x-ref="printContainer"
                    ...
                    <table id="example"
                        class="mt-2 table-auto"
                        style="width:100%">
                        <thead class="font-normal">
                            <tr>
                                <th class="px-2 py-2 text-sm font-semibold text-left text-gray-500 border">GUEST NAME</th>
                                <th class="px-2 py-2 text-sm font-semibold text-left text-gray-500 border">CONTACT NUMBER</th>
                            </tr>
                        </thead>
                        <tbody class="">
                            @foreach ($guests as $guest)
                                <tr>
                                    <td class="px-3 py-1 border"> {{ $guest->name }}</td>
                                    <td class="px-3 py-1 border"> {{ $guest->contact_number }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
