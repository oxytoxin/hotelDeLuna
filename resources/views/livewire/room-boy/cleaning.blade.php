        ...
        <div class="grid grid-cols-1 items-start gap-4 lg:grid-cols-3 lg:gap-8">
            ...
            <div class="grid grid-cols-1 gap-4 lg:col-span-2">
                ...
                <section aria-labelledby="profile-overview-title">
                    <div
                        class="overflow-hidden rounded-3xl lg:rounded-2xl border-4 border-white  bg-gray-50   shadow-lg">
                                ...
                                <div class="sm:flex sm:space-x-5">
                                    <div class="flex-shrink-0">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                            class="h-20 fill-green-500 mx-auto">
                                    ...
                                    <div class="grid grid-cols-2 lg:grid-cols-1 gap-2">
                                        ...
                                        <div>
                                            ...
                                            <h1 class="text-gray-600">Cleaning :
                                                @if (auth()->user()->room_boy->is_cleaning)
                                                    <span
                                                        class="bg-green-600 px-4 rounded-full font-semibold text-white">YES</span>
                                                @else
                                                    <span
                                                        class="bg-red-600 px-4 rounded-full font-semibold text-white">NO</span>
                                                @endif
                ...
                <section aria-labelledby="quick-links-title" class="bg-white">
                    ...
                    <div class="grid lg:grid-cols-2 grid-cols-1 gap-4" x-animate>
                        ...
                        $cleaningTime = new Carbon\Carbon(auth()->user()->room_boy->room->time_to_clean);
                    @endphp
                           
                        @endif --}}
                        @if ($this->designation)
                            @forelse ($rooms->whereIn('room_status_id',[7,8]) as $room)
                                @php
                                    $timeToClean = new Carbon\Carbon($room->time_to_clean);
                                        ...
                                        <div class="flex space-x-2 items-center relative  justify-between">
                                            ...
                                            <div class="sdsdsd relative">
                                                <x-button spinner="startRoomCleaning({{ $room->id }})"
                                                    wire:click="startRoomCleaning({{ $room->id }})" lg dark
                                                    class="font-semibold mt-1" label="START" />
                                            </div>
                                        </div>
                                        <div class="div">
                                            <div class="mt-4">
                                                <h3 class="font-medium">
                                                    <div
                                                        class="focus:outline-none font-semibold underline text-gray-700 uppercase text-xl">
                                                ...
                                                <div>
                                                    ...
                                                    @else
                                                        <p class="text-sm text-gray-500 truncate">Time to clean :
                                                            <span
                                                                class="text-red-500">{{ $timeToClean->diffForHumans() }}</span>
                                                        </p>
                                                    @endif
                                        ...
                                        <div class="flex space-x-2 items-center relative  justify-between">
                                            ...
                                            <div class="sdsdsd relative flex space-x-1 items-end">
                                                ...
                                                <x-button type="button" spinner="finish"
                                                    wire:click="finish({{ auth()->user()->room_boy->room_id }})" lg
                                                    negative class="font-semibold mt-1" label="FINISH" />
                                            </div>
                                        </div>
                                        <div class="div">
                                            <div class="mt-4">
                                                <h3 class="font-medium">
                                                    <div
                                                        class="focus:outline-none  flex flex-col text-gray-700 uppercase">
                        ...
                        <div class="p-6">
                            <div class="flex justify-between border-b pb-1">
                                <div class="flex items-center space-x-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-gray-700"
                                        width="24" height="24">
                                        <path fill="none" d="M0 0H24V24H0z" />
                                        <path
                                ...
                                <button class="hover:fill-green-700 fill-gray-700">
                                    @if ($filter == 'ASC')
                                        <svg wire:click="$set('filter','DESC')" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    @else
                                        <svg wire:click="$set('filter','ASC')" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 24 24" class="h-5 w-5">
                                            <path fill="none" d="M0 0H24V24H0z" />
                                            <path
                                            ...
                                            <li>
                                                <div class="relative pb-8">
                                                    ...
                                                    <div class="relative flex items-start space-x-3">
                                                        <div class="relative">
                                                            <div
                                                                class="bg-green-500 h-10 w-10 rounded-full grid place-content-center">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    viewBox="0 0 24 24" class="h-8 fill-white">
                                                                    <path fill="none" d="M0 0h24v24H0z" />
                                                                    <path
                                                            ...
                                                            <span
                                                                class="absolute -bottom-0.5 -right-1 rounded-xl bg-white px-0.5 py-px">
                                                                <!-- Heroicon name: mini/chat-bubble-left-ellipsis -->
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    viewBox="0 0 24 24" class="h-5 w-5 fill-gray-700">
                                                                    <path fill="none" d="M0 0h24v24H0z" />
                                                                    <path
                                                        ...
                                                        <div class="min-w-0 flex-1">
                                                            <div class="flex space-x-1 text-sm">
                                                                ...
                                                                @if ($cleaning->delayed == true)
                                                                    <h1>|</h1>
                                                                    <span
                                                                        class="px-2 text-sm bg-red-500 text-white rounded-full">Delayed</span>
                                                                @else
                                                                @endif
                                                            </div>
