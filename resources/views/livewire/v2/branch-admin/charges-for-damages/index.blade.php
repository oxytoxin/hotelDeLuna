<div x-data
    ...
    <x-my.table>
        ...
        @forelse ($chargesForDamages as $chargesForDamage)
            <tr>
                <x-my.table.cell>
                    {{ $chargesForDamage->name }}
                </x-my.table.cell>
                ...
                <x-my.table.cell>
                    <div class="flex justify-end space-x-2 px-2">
                        ...
                        <x-my.delete-button
                            ...
                            cancelButtonText : 'No', 
                            confirmMethod : 'deleteChargesForDamages',
                            'confirmParams' : {{ $chargesForDamage->id }}
                            })" />
                    </div>
                </x-my.table.cell>
            </tr>
    ...
    <div wire:key="modals">
        <form wire:submit.prevent="save">
            @csrf
            <x-my.modal title="{{ $editMode ? 'Edit Charges' : 'Create Charges' }}"
                :showOn="['show-modal']"
                :closeOn="['close-modal']">
