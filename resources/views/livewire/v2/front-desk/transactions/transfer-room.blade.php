<div x-data="{ formOpen: false }" x-on:close-form.window="formOpen=false">
  <div class="px-4 pt-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-center">
      ...
      <div>
        <x-my.button-primary py="py-1" x-on:click="formOpen = !formOpen" label="Transfer Room" />
      </div>
    </div>
    <div x-cloak x-show="formOpen" x-collapse>
      ...
      @else
        <div x-data="{ hasAvailableRoom: $wire.entangle('hasAvailableRoom') }" class="p-4 mt-5 bg-gray-100 rounded-lg">
          <div class="grid grid-cols-2 gap-3">
            <x-my.input.select label="Select Type" required wire:model="newRoomTypeId" placeholder="Select">
            ...
            <x-my.input.select required label="Select Floor" wire:model="newRoomFloorId" placeholder="Select">
            ...
            <div x-cloak x-show="hasAvailableRoom" x-collapse class="grid grid-cols-2 col-span-2 gap-3">
              <x-my.input.select required label="Select Room" wire:model="newRoomId" placeholder="Select">
              ...
              <x-my.input.select required wire:model.defer="oldRoomStatus" label="Select Old Room Status"
                placeholder="Select">
              ...
              <x-my.input.textarea required wire:model.defer="reason" label="Reason"></x-my.input.textarea>
              <div class="col-span-2">
                <x-my.input placeholder="Enter authorization code" wire:model.defer="authorizationCode"
                  label="Authorization Code" type="password" required />
              </div>
              <div class="col-span-2 py-3">
                <dl class="pt-6 space-y-6 text-sm font-medium text-gray-500 border-t border-gray-200">
                  ...
                  <div x-animate>
                    @if ($newRoomAmount < $oldRoomAmount && $newRoomAmount != null)
                      <x-my.input.select required label="Save excess amount as deposit?"
            ...
            <div x-cloak x-show="hasAvailableRoom==false" x-collapse class="grid grid-cols-1 col-span-2 gap-3">
          ...
          <div class="overflow-hidden shadow-sm ring-1 ring-black ring-opacity-5">
            <table class="min-w-full divide-y divide-gray-300">
              <thead class="bg-primary-600">
                <tr>
                  <th scope="col"
                    class="py-3.5 w-96 pl-4 pr-3 text-left text-sm font-semibold text-white sm:pl-6 lg:pl-8">
                    Details
                  </th>
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                ...
                @empty
                  <tr>
                    <td colspan="4" class="py-3.5 pl-4 pr-3 text-center text-xs text-gray-900 sm:pl-6 lg:pl-8">
                      No data available
                    </td>
                  </tr>
                @endforelse
