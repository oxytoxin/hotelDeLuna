        ...
        <div class="p-4 mt-5 bg-gray-100 rounded-lg">
          <div>
            <div class="grid grid-cols-1 gap-4">
              <x-my.input.select label="Select Hours" wire:model="extensionHour" placeholder="Select">
                @foreach ($extensionRates as $extensionRate)
                  <option value="{{ $extensionRate->id }}">
                    {{ $extensionRate->hours }} Hours
                  </option>
                @endforeach
              </x-my.input.select>
              <div class="mt-3">
                <h1 class="text-lg font-semibold text-gray-700">
                  Total Amount Payable : ₱ {{ $extensionAmount ?? 'N/A' }}
                </h1>
              </div>
            </div>
          </div>
            ...
            <div class="flex items-center space-x-3">
              ...
              <x-my.button-success
                x-on:click="$dispatch('confirm',{
                                    ...
                                    confirmMethod : 'confirmExtension',
                                })"
                label="Save Record" />
            </div>
          </div>
  ...
  @else
    <div class="px-5">
      <div class="grid items-center justify-center gap-3">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-40 mt-10" viewBox="0 0 524.67001 418.27099"
          ...
          <path
            ...
            fill="#e6e6e6" />
          <g>
            <circle cx="218.47958" cy="311.43145" r="73" fill="#f50057" />
            <g>
          ...
          <div class="w-full ml-3">
            ...
            <div class="mt-2 text-sm text-red-700">
              <ul role="list" class="pl-5 space-y-1 list-disc">
                <li x-on:mouseover="$dispatch('reset-guide-show')" x-on:mouseleave="$dispatch('reset-guide-hide')"
                  title="Look Around">
                  Branch resetting time is not set OR .
                </li>
                <li x-on:mouseover="$dispatch('ext-guide-show')" x-on:mouseleave="$dispatch('ext-guide-hide')"
                  title="Look Around">
