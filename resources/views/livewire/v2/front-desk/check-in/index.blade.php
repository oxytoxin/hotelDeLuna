<div>
    <div class="grid grid-cols-12 gap-5">
                            ...
                            <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                                <table class="min-w-full divide-y divide-gray-300">
                                    <thead class="bg-primary-600">
                                        <tr>
                                            <th scope="col"
                                                class="py-3 pl-4 pr-3 text-left text-xs font-medium uppercase tracking-wide text-white sm:pl-6">
                                                QR Code
                                            </th>
                                            <th scope="col"
                                                class="px-3 py-3 text-left text-xs font-medium uppercase tracking-wide text-white">
                                                Name
                                            </th>
                                            <th scope="col"
                                                class="px-3 py-3 text-left text-xs font-medium uppercase tracking-wide text-white">
        ...
        <div class="col-span-4 mb-10 grid space-y-5 border-l p-2">
            <div>
                ...
                <ul role="list"
                    ...
                    @forelse ($recentlyCheckedInGuests as $recentGuest)
                        <li class="flex py-4">
                            <img class="h-10 w-10 rounded-full ring-2 ring-green-600"
                        ...
                        <div>
                            <dl
                                ...
                                <div x-data="{ guestExcessAmount: $wire.entangle('guestExcessAmount') }"
                                    class="mt-2 grid grid-cols-1 gap-3 pt-2">
