...
<body class="font-rubik antialiased " x-data="{ logout: false }">
    ...
    <div class="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col">
      ...
      <div class="flex flex-grow flex-col overflow-y-auto border-r border-gray-200 bg-gray-700 pt-5">
        <div class="flex flex-shrink-0 items-center px-4">
          ...
          <span class="text-xl font-semibold text-white uppercase ml-2">{{ app_name() }}</span>
        </div>
        <div class="mt-20 flex flex-grow flex-col">
          <nav class="flex-1 space-y-1 pb-4">
            <!-- Current: "bg-gray-100 text-gray-900", Default: "text-gray-600 hover:bg-gray-50 hover:text-gray-900" -->
            <a href="{{ route('office.dashboard') }}"
              class="{{ request()->routeIs('office.dashboard') ? 'bg-gray-50 before:w-1 before:h-full before:bg-green-500 before:absolute before:right-0 font-semibold text-gray-700 fill-gray-700' : 'text-gray-400 fill-gray-400' }} relative hover:bg-gray-50 hover:text-gray-500 hover:fill-gray-500  px-4  group py-2 flex items-center text-sm
              ">
            ...
            <a href="{{ route('office.sales') }}"
              class="{{ request()->routeIs('office.sales') ? 'bg-gray-50 before:w-1 before:h-full before:bg-green-500 before:absolute before:right-0 font-semibold text-gray-700' : 'text-gray-400' }} hover:bg-gray-50  relative hover:text-gray-500 hover:fill-gray-500 fill-gray-400 px-4  group py-2 flex items-center text-sm
              ">
            ...
            <a href="{{ route('office.expenses') }}"
              class="{{ request()->routeIs('office.expenses') ? 'bg-gray-50 before:w-1 before:h-full before:bg-green-500 before:absolute before:right-0 font-semibold text-gray-700' : 'text-gray-400' }} relative hover:bg-gray-50 hover:text-gray-500 hover:fill-gray-500 fill-gray-400 px-4  group py-2 flex items-center text-sm
              ">
            ...
            <a href="{{ route('office.report') }}"
              class="{{ request()->routeIs('office.report') ? 'bg-gray-50 before:w-1 before:h-full before:bg-green-500 before:absolute before:right-0 font-semibold text-gray-700' : 'text-gray-400' }} relative hover:bg-gray-50 hover:text-gray-500 hover:fill-gray-500 fill-gray-400 px-4  group py-2 flex items-center text-sm
              ">
