            ...
            <div class="overflow-y-auto pt-5 pb-4">
                ...
                <nav class="flex-1 bg-blue-500 py-3 pl-3">
                    <a href="{{ route('branch.dashboard') }}"
                        @class([
                            ...
                            'text-white border-white' => request()->is('branch/dashboard*'),
                            'text-gray-100 hover:text-white border-transparent' => !request()->is(
                                'branch/dashboard*'
                            ),
                        ])>
                    ...
                    <a href="{{ route('branch.guests') }}"
                        @class([
                            'group flex items-center px-4 py-1.5 text-sm font-medium border-r-8',
                            'text-white border-white' => request()->is('branch/guests*'),
                            'text-gray-100 hover:text-white border-transparent' => !request()->is(
                                'branch/guests*'
                            ),
                        ])>
                ...
                <nav class="flex-1 bg-yellow-500 py-3 pl-3">
                    <a href="{{ route('branch.manage-types') }}"
                        @class([
                            'group flex items-center px-4 py-1.5 text-sm font-medium border-r-8',
                            'text-white border-white' => request()->is('branch/manage-types*'),
                            'text-gray-100 hover:text-white border-transparent' => !request()->is(
                                'branch/manage-types*'
                            ),
                        ])>
                    ...
                    <a href="{{ route('branch.manage-rates') }}"
                        @class([
                            'group flex items-center px-4 py-1.5 text-sm font-medium border-r-8',
                            'text-white border-white' => request()->is('branch/manage-rates*'),
                            'text-gray-100 hover:text-white border-transparent' => !request()->is(
                                'branch/manage-rates*'
                            ),
                        ])>
                    ...
                    <a href="{{ route('branch.manage-rooms') }}"
                        @class([
                            'group flex items-center px-4 py-1.5 text-sm font-medium border-r-8',
                            'text-white border-white' => request()->is('branch/manage-rooms*'),
                            'text-gray-100 hover:text-white border-transparent' => !request()->is(
                                'branch/manage-rooms*'
                            ),
                        ])>
                    ...
                    <a href="{{ route('branch.manage-users') }}"
                        @class([
                            'group flex items-center px-4 py-1.5 text-sm font-medium border-r-8',
                            'text-white border-white' => request()->is('branch/manage-users*'),
                            'text-gray-100 hover:text-white border-transparent' => !request()->is(
                                'branch/manage-users*'
                            ),
                        ])>
                    ...
                    <a href="{{ route('branch.discounts') }}"
                        @class([
                            'group flex items-center px-4 py-1.5 text-sm font-medium border-r-8',
                            'text-white border-white' => request()->is(
                    ...
                    <a href="{{ route('branch.extension-amounts') }}"
                        @class([
                            'group flex items-center px-4 py-1.5 text-sm font-medium border-r-8',
                            'text-white border-white' => request()->is('branch/extension-amounts*'),
                            'text-gray-100 hover:text-white border-transparent' => !request()->is(
                ...
                <nav class="flex-1 bg-green-500 py-3 pl-3">
                    ...
                    <a href="{{ route('branch.check-in') }}"
                        @class([
                            'group flex items-center px-4 py-1.5 text-sm font-medium border-r-8',
                            'text-white border-white' => request()->is('branch/check-in*'),
                            'text-gray-100 hover:text-white border-transparent' => !request()->is(
                                'branch/check-in*'
                            ),
                        ])>
                    ...
                    <a href="{{ route('branch.check-out') }}"
                        @class([
                            'group flex items-center px-4 py-1.5 text-sm font-medium border-r-8',
                            'text-white border-white' => request()->is('branch/check-out*'),
                            'text-gray-100 hover:text-white border-transparent' => !request()->is(
                                'branch/check-out*'
                            ),
                        ])>
                    ...
                    <a href="{{ route('branch.guest-transaction') }}"
                        @class([
                            'group flex items-center px-4 py-1.5 text-sm font-medium border-r-8',
                            'text-white border-white' => request()->is('branch/guest-transaction*'),
                            'text-gray-100 hover:text-white border-transparent' => !request()->is(
                    ...
                    <a href="{{ route('branch.room-monitoring') }}"
                        @class([
                            'group flex items-center px-4 py-1.5 text-sm font-medium border-r-8',
                            'text-white border-white' => request()->is('branch/room-monitoring*'),
                            'text-gray-100 hover:text-white border-transparent' => !request()->is(
                    ...
                    <a href="{{ route('branch.priority-room') }}"
                        @class([
                            'group flex items-center px-4 py-1.5 text-sm font-medium border-r-8',
                            'text-white border-white' => request()->is('branch/priority-room*'),
                            'text-gray-100 hover:text-white border-transparent' => !request()->is(
                ...
                <nav class="flex-1 bg-red-500 py-3 pl-3">
                    <a href="{{ route('branch.room-boy-designations') }}"
                        @class([
                            'group flex items-center px-4 py-1.5 text-sm font-medium border-r-8',
                            'text-white border-white' => request()->is('branch/room-boy-designations*'),
                            'text-gray-100 hover:text-white border-transparent' => !request()->is(
