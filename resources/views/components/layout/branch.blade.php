...
<div>
    ...
    -->
      ...
      -->
        ...
        -->
              ...
              -->
                            <svg class="flex-shrink-0 w-4 h-4 mr-4 text-gray-500" xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col">
        <div class="flex flex-col flex-1 min-h-0 bg-white shadow-md">
            <div class="pt-5 pb-4 overflow-y-auto ">
                ...
                <nav class="flex-1 pl-3 bg-white ">
                    <a href="{{ route('branch.dashboard') }}" @class([
                    ...
                    <a href="{{ route('branch.guests') }}" @class([
                        'group flex items-center px-2 py-1.5 text-sm font-medium border-r-4',
                ...
                <hr>
                <nav class="flex-1 pl-3 bg-white ">
                    <a href="{{ route('branch.manage-types') }}" @class([
                        'group flex items-center px-2 py-1.5 text-sm font-medium border-r-4',
                    ...
                    <a href="{{ route('branch.manage-rates') }}" @class([
                        'group flex items-center px-2 py-1.5 text-sm font-medium border-r-4',
                    ...
                    <a href="{{ route('branch.manage-rooms') }}" @class([
                        'group flex items-center px-2 py-1.5 text-sm font-medium border-r-4',
                    ...
                    <a href="{{ route('branch.manage-users') }}" @class([
                        'group flex items-center px-2 py-1.5 text-sm font-medium border-r-4',
                    ...
                    <a href="{{ route('branch.discounts') }}" @class([
                        'group flex items-center px-2 py-1.5 text-sm font-medium border-r-4',
                    ...
                    <a href="{{ route('branch.extension-amounts') }}" @class([
                        'group flex items-center px-2 py-1.5 text-sm font-medium border-r-4',
                        'text-gray-700 border-primary-700' => request()->is(
                    ...
                    <a href="{{ route('branch.charges-on-stain-and-damages') }}" @class([
                        'group flex items-center px-2 py-1.5 text-sm font-medium border-r-4',
                        'text-gray-700 border-primary-700' => request()->is(
                    ...
                    <a href="{{ route('branch.manage-requestable-items') }}" @class([
                        'group flex items-center px-2 py-1.5 text-sm font-medium border-r-4',
                        'text-gray-700 border-primary-700' => request()->is(
                ...
                <nav class="flex-1 pl-3 bg-white ">
                    ...
                    <a href="{{ route('branch.check-in') }}" @class([
                        'group flex items-center px-2 py-1.5 text-sm font-medium border-r-4',
                    ...
                    <a href="{{ route('branch.check-out') }}" @class([
                        'group flex items-center px-2 py-1.5 text-sm font-medium border-r-4',
                    ...
                    <a href="{{ route('branch.guest-transaction') }}" @class([
                        'group flex items-center px-2 py-1.5 text-sm font-medium border-r-4',
                        'text-gray-700 border-primary-700' => request()->is(
                    ...
                    <a href="{{ route('branch.room-monitoring') }}" @class([
                        'group flex items-center px-2 py-1.5 text-sm font-medium border-r-4',
                        'text-gray-700 border-primary-700' => request()->is(
                    ...
                    <a href="{{ route('branch.priority-room') }}" @class([
                        'group flex items-center px-2 py-1.5 text-sm font-medium border-r-4',
                        'text-gray-700 border-primary-700' => request()->is(
                ...
                <hr>
                <nav class="flex-1 pl-3 bg-white ">
                    <a href="{{ route('branch.room-boy-designations') }}" @class([
                        'group flex items-center px-2 py-1.5 text-sm font-medium border-r-4',
                        'text-gray-700 border-primary-700' => request()->is(
    ...
    <div class="flex flex-col flex-1 md:pl-64">
        ...
        <main class="flex-1">
            <div x-data="{ scrollTop: 0 }" x-on:scroll.window="scrollTop = window.scrollY"
                x-bind:class="scrollTop > 0 ? 'backdrop-blur-sm shadow-md' : ''" x-init="scrollTop = window.scrollY"
