        ...
        <div class="h-0 flex-1 overflow-y-auto pt-5 pb-4">
          ...
          <nav class="mt-5 space-y-1 px-2">
            ...
            <a href="#"
              ...
              -->
              <svg class="mr-4 h-4 w-4 flex-shrink-0 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none"
    ...
    <div class="flex min-h-0 flex-1 flex-col bg-white shadow-md">
      <div class="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
        ...
        <nav class="mt-5 flex-1 space-y-1 border-t bg-white py-3 pt-5">
          <a href="{{ route('front-desk.dashboard') }}" @class([
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="mr-3 h-4 w-4 flex-shrink-0">
              <path stroke-linecap="round" stroke-linejoin="round"
                d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
            </svg>
            Dashboard
          </a>
          <a href="{{ route('front-desk.check-in') }}" @class([
              'group flex items-center px-6 py-1.5 text-sm font-medium border-r-4',
          ...
          <a href="{{ route('front-desk.check-out') }}" @class([
              'group flex items-center px-6 py-1.5 text-sm font-medium border-r-4',
          ...
          <a href="{{ route('front-desk.guest-transaction') }}" @class([
              'group flex items-center px-6 py-1.5 text-sm font-medium border-r-4',
          ...
          <a href="{{ route('front-desk.room-monitoring') }}" @class([
              'group flex items-center px-6 py-1.5 text-sm font-medium border-r-4',
              'text-gray-700 border-primary-700' => request()->is(
          ...
          <a href="{{ route('front-desk.priority-room') }}" @class([
              'group flex items-center px-6 py-1.5 text-sm font-medium border-r-4',
              'text-gray-700 border-primary-700' => request()->is(
