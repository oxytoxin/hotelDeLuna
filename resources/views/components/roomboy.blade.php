    ...
    <header class="bg-gradient-to-r from-gray-800 to-gray-600 pb-32">
      <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <div class="relative flex flex-wrap  items-center justify-center lg:justify-between">
          <!-- Logo -->
          <div
            class="absolute flex justify-between w-full items-center left-0 flex-shrink-0 mt-20 lg:mt-0 py-5 lg:static">
            <a href="#">
            ...
            <div class="hidden lg:ml-4 lg:flex lg:items-center relative lg:py-5 lg:pr-0.5">
              <div class="relative inline-block px-3 text-left">
                <div>
                  <button x-on:click="logout = !logout" type="button"
                    class="group w-full rounded-md  px-3.5 py-2 text-left text-sm font-medium text-gray-700 hover:bg-gray-100 hover:bg-opacity-50 focus:outline-none"
                ...
                <div x-show="logout" x-cloak x-on:click.away="logout = false"
                  ...
                  <div class="py-1" role="none">
                    <a x-on:click="confirm = true"
                      class="text-gray-700 cursor-pointer hover:text-green-800 px-4 py-2 text-sm flex items-center space-x-1"
                      role="menuitem" tabindex="-1" id="options-menu-item-5 "><svg xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="absolute right-0 flex-shrink-0 lg:hidden">
                ...
                <button type="button"
                  ...
                  aria-expanded="false">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="rotate-90 fill-white"
                    width="24" height="24">
                    <path fill="none" d="M0 0h24v24H0z" />
                    <path
                      d="M5 11h8v2H5v3l-5-4 5-4v3zm-1 7h2.708a8 8 0 1 0 0-12H4A9.985 9.985 0 0 1 12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10a9.985 9.985 0 0 1-8-4z" />
            ...
            <div class="block lg:hidden">
              <button x-on:click="confirm = true">
                <svg class="w-6 h-6 text-white rotate-180" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
    ...
    <footer>
      <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <div class="border-t border-gray-200 py-8 text-center text-sm text-gray-500 sm:text-left"><span
            class="block sm:inline">&copy; 2022 J7 IT SOLUTIONS & SERVICES</span> <span class="block sm:inline">All
